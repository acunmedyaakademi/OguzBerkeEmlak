...
namespace DAL.Migrations
{
    ...
    [Migration("20230927104347_initDb")]
            ...
            modelBuilder.Entity("Emlak.Entities.Calisan", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 27, 13, 43, 46, 984, DateTimeKind.Local).AddTicks(1393));
            ...
            modelBuilder.Entity("Emlak.Entities.Portfoy", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 27, 13, 43, 46, 984, DateTimeKind.Local).AddTicks(3555));
                    ...
                    b.Property<string>("PortfoySahibi")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PortfoySahibi2ID")
                        .HasColumnType("int");

                    b.Property<int>("PortfoySahibiID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Concrate.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 27, 13, 43, 46, 983, DateTimeKind.Local).AddTicks(5782));
            ...
            modelBuilder.Entity("Entities.Concrate.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 27, 13, 43, 46, 983, DateTimeKind.Local).AddTicks(8575));
